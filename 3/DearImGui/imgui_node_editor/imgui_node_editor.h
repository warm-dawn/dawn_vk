...
template <typename Tag>
Tag SafePointerType<Tag>::Invalid = { 0 };
...
struct NodeId final:public Details::SafePointerType<NodeId>
{
    using SafePointerType::SafePointerType;
};

struct LinkId final:public Details::SafePointerType<LinkId>
{
    using SafePointerType::SafePointerType;
};

struct PinId final:public Details::SafePointerType<PinId>
{
    using SafePointerType::SafePointerType;
};
